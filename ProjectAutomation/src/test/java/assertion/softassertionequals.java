...
public class softassertionequals {
...
//		soft.assertEquals(actualtitle, expectedtitle,"home page title is not same");
	...
	@Test
		public void test1() {
			...
			SoftAssert soft =new SoftAssert();
			soft.assertEquals(actualtitle, expectedtitle,"home page is not same");
			soft.assertEquals(actualURL, expectedURL);
			soft.assertEquals(actualbutton, expectedbutton,"button is not same");
	...
	public void test2() {
		...
		soft.assertEquals(actualtitle, expectedtitle);
		soft.assertEquals(actualURL, expectedURL);
		soft.assertEquals(actualbutton, expectedbutton);
