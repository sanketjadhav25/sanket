...
public class softassertionfalse {
	...
	//if actual result == true then testcase is passed
	//if actual result == false then testcase is failed
	...
	public void test1() {
	    ...
	    soft.assertFalse(result,"home paage is not same");
	    soft.assertAll();
	}
