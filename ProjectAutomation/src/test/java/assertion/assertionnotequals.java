...
public class assertionnotequals {
	...
	//if actual result is equals to expected result then testcase is failed
	//if actual result is not equals to expected result then testcase is passed
	//third argument is for understand the defect present in the testcase
	@Test
	public void test1() {
		System.out.println("test1-testclass2");
		String actualtitle="forgotten home page";
		String expectedtitle="forgotten home page";
		Assert.assertNotEquals(actualtitle, expectedtitle,"home page title is same");
	}
	@Test
	public void test2() {
		System.out.println("test1-testclass2");
